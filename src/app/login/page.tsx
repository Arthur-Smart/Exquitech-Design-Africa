...
const page = () => {
  return (
    <main
      className={`${styles.login__page} flex flex-col items-center justify-center`}
    >
      <h2 className="font-bold text-lg">Welcome to Exquitech</h2>
      <p className="text-[14px] text-gray-400">
        Sign up to create an account. We are here to serve you
      </p>
      <section
        className={`${styles.login__wrapper} flex flex-col border-gray-300 border-[1px] rounded-md text-[14px] text-gray-300 mt-4 p-5`}
      >
